...
export const TrainsMenu = () => {
    return (
        <>
            <div className="trains-menu">
                <ul className="trains-menu-paginations">
                    <li className="trains-menu-pagination">
                        <button className="btn trains-menu-pagination-btn">
                    ...
                    <li className="trains-menu-pagination">
                        <button className="btn trains-menu-pagination-btn trains-menu-pagination-btn-active">
                            1
                        </button>
                    </li>
                    <li className="trains-menu-pagination">

        ...
        <>
            <div className='vagon-header'>
                <div className='vagon-header-amount'>
                    ...
                    <button className='btn vagon-header-number'>09</button>
                </div>
                ...
                <div className='vagon-seats-block'>
                    <div className='vagon-seats-amount'>
                        <div className='vagon-seats-title'>
                            Места
                            <span className='vagon-seats-amount_amount'>11</span>
                        </div>
                        <ul className='vagon-seats-amount-list'>
                            <li className='vagon-seats-amount-item'>
                                Верхние
                                <span className='vagon-seats-amount-item_amount'>3</span>
                            </li>
                            <li className='vagon-seats-amount-item'>
                                Нижние
                                <span className='vagon-seats-amount-item_amount'>8</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="type-vagon-second-class">
                    <div className="type-vagon-second-class-coupe">
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">2</button>
                            <button className="btn type-vagon-second-class-seat">1</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">4</button>
                            <button className="btn type-vagon-second-class-seat">3</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">6</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">5</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">8</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">7</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">10</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">9</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">12</button>
                            <button className="btn type-vagon-second-class-seat">11</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">14</button>
                            <button className="btn type-vagon-second-class-seat">13</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">16</button>
                            <button className="btn type-vagon-second-class-seat">15</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat">18</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">17</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">20</button>
                            <button className="btn type-vagon-second-class-seat">19</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">22</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">21</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">24</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">23</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">26</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">25</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat busy-seat">28</button>
                            <button className="btn type-vagon-second-class-seat">27</button>
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat">30</button>
                            <button className="btn type-vagon-second-class-seat busy-seat">29</button> 
                        </div>
                        <div className="type-vagon-second-class-seats">
                            <button className="btn type-vagon-second-class-seat">32</button>
                            <button className="btn type-vagon-second-class-seat">31</button>
                        </div>
                    </div>
                </div>
            </div>

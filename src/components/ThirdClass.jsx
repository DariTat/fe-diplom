        ...
        <>
            <div className='vagon-header'>
                <div className='vagon-header-amount'>
                    ...
                    <button className='btn vagon-header-number'>10</button>
                    <button className='btn vagon-header-number vagon-number-active'>12</button>
                    <button className='btn vagon-header-number'>15</button>
                </div>
                ...
                <div className='vagon-seats-block'>
                    <div className='vagon-seats-amount'>
                        <div className='vagon-seats-title'>
                            Места
                            <span className='vagon-seats-amount_amount'>21</span>
                        </div>
                        <ul className='vagon-seats-amount-list'>
                            <li className='vagon-seats-amount-item'>
                                Верхние
                                <span className='vagon-seats-amount-item_amount'>10</span>
                            </li>
                            <li className='vagon-seats-amount-item'>
                                Нижние
                                <span className='vagon-seats-amount-item_amount'>11</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='vagon-seats-service-block'>
                        ...
                        <button className='btn vagon-seats-service-btn'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="35" viewBox="0 0 36 35" fill="none" className='svg-bedsheets'>
            ...
            <div className="type-vagon-third-class-block">
                ...
                <div className="type-vagon-third-class">
                    <div className="type-vagon-third-class-reserved">
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">2</button>
                            <button className="btn type-vagon-third-class-seat">1</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">4</button>
                            <button className="btn type-vagon-third-class-seat">3</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">6</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">5</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">8</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">7</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">10</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">9</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">12</button>
                            <button className="btn type-vagon-third-class-seat">11</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">14</button>
                            <button className="btn type-vagon-third-class-seat">13</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">16</button>
                            <button className="btn type-vagon-third-class-seat">15</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat">18</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">17</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">20</button>
                            <button className="btn type-vagon-third-class-seat">19</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">22</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">21</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">24</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">23</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">26</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">25</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat busy-seat">28</button>
                            <button className="btn type-vagon-third-class-seat">27</button>
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat">30</button>
                            <button className="btn type-vagon-third-class-seat busy-seat">29</button> 
                        </div>
                        <div className="type-vagon-third-class-seats">
                            <button className="btn type-vagon-third-class-seat">32</button>
                            <button className="btn type-vagon-third-class-seat">31</button>
                        </div>
                    </div>
                    <div className='type-vagon-third-class-lateral'>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">33</button>
                            <button className="btn type-vagon-third-class-seat-lateral">34</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">35</button>
                            <button className="btn type-vagon-third-class-seat-lateral">36</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">37</button>
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">38</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">39</button>
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">40</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">41</button>
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">42</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">43</button>
                            <button className="btn type-vagon-third-class-seat-lateral">44</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">45</button>
                            <button className="btn type-vagon-third-class-seat-lateral">46</button>
                        </div>
                        <div className="type-vagon-third-class-seats-lateral">
                            <button className="btn type-vagon-third-class-seat-lateral busy-seat">47</button>
                            <button className="btn type-vagon-third-class-seat-lateral">48</button>
                        </div>
                    </div>
                </div>
            </div>

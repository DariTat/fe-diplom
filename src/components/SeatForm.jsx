            ...
            <section className="seat-form">
                ...
                <div className="seat-form-there">
                    ...
                    <div className='seat-form-info'>
                        ...
                        <div className='seat-form-direction'>
                            <p className='seat-form-train-number'>116C</p>
                            <ul className='seat-form-train-points'>
                                ...
                                <li className='seat-form-train-point-depature'>Москва
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="8" viewBox="0 0 14 8" fill="none" className='svg-train'>
                                ...
                                <li className='seat-form-train-point-arrival'>Санкт-Петербург</li>
                            </ul>
                        </div>
                    ...
                    <div className='number-tickets'>
                        ...
                        <div className='number-tickets-menu'>
                            <div className='number-tickets-menu-item selected-type-ticket'>
                                <div className='number-tickets-type'>
                                    <span className='number-tickets-input-text'>Взрослых - </span>
                                    <input type='number' className='number-tickets-input' id='inputTypeTicket'/>
                            ...
                            <div className='number-tickets-menu-item'>
                                <div className='number-tickets-type'>
                                    ...
                                    <input type='number' className='number-tickets-input input-child-no-seats' id='inputTypeTicket'/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='type-vagon'>
                        ...
                        <div className='type-vagon-items'>
                            <button className='btn type-vagon-btn' onClick={() => setSelectedType('fourth')}>
                            ...
                            <button className='btn type-vagon-btn' onClick={() => setSelectedType('third')}>
                            ...
                            <button className='btn type-vagon-btn' onClick={() => setSelectedType('second')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" className='type-vagon-svg'>
                            ...
                            <button className='btn type-vagon-btn' onClick={() => setSelectedType('first')}>
                ...
                <div className="seat-form-back">
                    ...
                    <div className='type-vagon'>
                        <h3 className='type-vagon-title'>Тип вагона</h3>
                        <div className='type-vagon-items'>
                            <button className='btn type-vagon-btn' onClick={() => setSelectedTypeBack('fourth')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="31" height="50" viewBox="0 0 31 50" fill="none" className='type-vagon-svg'>
                            ...
                            <button className='btn type-vagon-btn' onClick={() => setSelectedTypeBack('third')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" className='type-vagon-svg'>
                            ...
                            <button className='btn type-vagon-btn' onClick={() => setSelectedTypeBack('second')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" className='type-vagon-svg'>
                            ...
                            <button className='btn type-vagon-btn' onClick={() => setSelectedTypeBack('first')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="57" height="50" viewBox="0 0 57 50" fill="none" className='type-vagon-svg'>
                ...
                <div className='seat-form-next'>
                    <button className='btn seat-form-next-btn' onClick={handleClickNext}>Далее</button>
                </div>
            </section>
        </>
    )

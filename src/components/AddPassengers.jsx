...
export const AddPassengers = ({count, setCount}) => {
    ...
    const handleClick = () => {
        setCount((prevCount) => [...prevCount, count.length + 1])
    }

    return (
        <>
            <div className="add-passenger-block">
                <h2 className="add-passenger-title">Добавить пассажира</h2>
                <button className="btn add-passenger-btn" onClick={handleClick}>
